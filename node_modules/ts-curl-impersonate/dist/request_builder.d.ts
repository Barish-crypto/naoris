...
export declare class RequestBuilder {
     ...
     * @returns The RequestBuilder instance
     */
    flag(name: string, value?: string): this;
    /**
     ...
     * @returns The RequestBuilder instance
     */
    flags(flags: Record<string, string | undefined>): this;
    /**
     ...
     * @returns The RequestBuilder instance
     */
    preset<T extends BrowserType>(preset: RequestPreset<T>): this;
    /**
     * Send the request
     * @returns A promise that resolves with the response and details of the request
     */
    send(): Promise<CurlResultOk | CurlResultErr>;
    private buildFlags;
